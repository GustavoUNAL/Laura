        ...
        <div id="about" className="home-about">
            ...
            <div className="skills-icons-container">
                <div className="skills-grid">
                    <div className="skill-icon" style={{ animationDelay: '0s' }}>
                    ...
                    <div className="skill-icon" style={{ animationDelay: '0.2s' }}>
                        <div className="icon-bg">
                            <span className="icon">🎨</span>
                        </div>
                    ...
                    <div className="skill-icon" style={{ animationDelay: '0.4s' }}>
                        <div className="icon-bg">
                            <span className="icon">👥</span>
                        </div>
                    ...
                    <div className="skill-icon" style={{ animationDelay: '0.6s' }}>
                        <div className="icon-bg">
                            <span className="icon">🔬</span>
                        </div>
                    ...
                    <div className="skill-icon" style={{ animationDelay: '0.8s' }}>
                        <div className="icon-bg">
                            <span className="icon">💡</span>
                        </div>
                    ...
                    <div className="skill-icon" style={{ animationDelay: '1s' }}>
                        <div className="icon-bg">
                            <span className="icon">🌟</span>
                        </div>
